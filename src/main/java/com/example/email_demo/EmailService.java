...
public class EmailService {
    ...
    public void sendRegistrationMail(RegistrationMailDto registrationMailDto) {
        try {
            ...
            helper.setTo(registrationMailDto.email);
            helper.setSubject(registrationMailDto.subject);
    ...
    public void sendActivationMail(ActivationMailDto activationMailDto) {
        try {
            ...
            helper.setTo(activationMailDto.email);
            helper.setSubject(activationMailDto.subject);
            helper.setText(html, true);
